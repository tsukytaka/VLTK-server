...
----------------------------------------------------------------------------------------------------
-- CÊp §é T¹o Nh©n VËt
CapKhiLoginVaoServer = 1 -- 0: §ãng, 1: Më
CapDo = 90

--Giíi H¹n IP
GioiHanLoginIP = 0 -- 0: §ãng, 1: Më
SoLuongAccGioiHan = 8
...
ThuNghiemMayChu = 0 -- 0: §ãng, 1: Më

----------------------------------------------------------------------------------------------------
-- NhiÖm Vô Mçi Ngµy
NhiemVuMoiNgay = 1 -- 0: §ãng, 1: Më

----------------------------------------------------------------------------------------------------
-- Giíi h¹n TÈy Tñy Kinh & Vâ L©m MËt TÞch
GioiHanTTK = 200
GioiHanVLMT = 200

----------------------------------------------------------------------------------------------------
-- NhiÖm Vô Hoµng Kim Long Ngò - ChØ lµm ë Ba L¨ng HuyÖn
NPCLongNgu = 1 -- 0: §ãng, 1: Më

----------------------------------------------------------------------------------------------------
NPCTienTrang = 1 -- 0: §ãng, 1: Më nÕu më Long Ngò

-- §æi TiÒn TÖ t¹i TiÒn Trang (TiÒn V¹n <=> TiÒn §ång) - Kh«ng nªn bËt ®Ó tr¶i nghiÖm game tèt h¬n
DoiTienTe = 0 -- 0: §ãng, 1: Më

----------------------------------------------------------------------------------------------------
-- TÝnh n¨ng S­ §å
SuDoThiep = 0 -- 0: §ãng, 1: Më
...
----------------------------------------------------------------------------------------------------
-- §å TÝm
DucVatPham = 1 -- 0: §ãng, 1: Më
AllowCheTaoDoTim = 1 -- 0: §ãng, 1: Më

----------------------------------------------------------------------------------------------------
-- Kú Tr©n C¸c
OpenShopKTC = 1 -- 0: §ãng, 1: Më
...
Cfg_TuyetDinhTrangBi = 1 -- 0: §ãng, 1: Më

-- TuyÖt §Ønh Vò KhÝ (Bao gåm rít nguyªn liÖu vµ n©ng cÊp)
Cfg_TuyetDinhVuKhi = 1 -- 0: §ãng, 1: Më

-- Boss TuyÖt §Ønh Vò §Õ
Cfg_BossTuyetDinhVuDe = 1 -- Th¸ch ®Êu TuyÖt §Ønh Vò §Õ - 0: §ãng, 1: Më
KinhNghiemGietBossTuyetDinhVuDe = 50000000
KinhNghiemNguoiChoiDungXungQuanhVuDe = 10000000
TyLeRotTranBangChiBao = 100 -- %

----------------------------------------------------------------------------------------------------
-- HÖ Thèng §æi VËt PhÈm - Trang BÞ
...
-- Lo¹i h×nh nhiÖm vô D· TÈu
DaTauDoChiMatChi = 1 -- 0: D· TÈu nguyªn b¶n, 1: D· TÈu chØ lµm nhiÖm vô §å ChÝ vµ MËt ChÝ

-- TØ lÖ phÇn th­ëng tiÒn v¹n vµ kinh nghiÖm D· TÈu
PhanThuongTienVan = 0.15
PhanThuongKinhNghiem = 2

-- Dïng tiÒn v¹n hoµn thµnh D· TÈu
HoanThanhDaTau = 1 -- 0: §ãng, 1: Më
SoTienHoanThanhDaTau = 50 -- v¹n l­îng

----------------------------------------------------------------------------------------------------
-- Phong L¨ng §é
-- B¾t ®Çu b¸o danh mçi giê lóc phót thø 45. VÝ dô: 1:45, 2:45, 3:45, ..., 22:45, 23:45
PhongLangDo = 1 -- 0: §ãng, 1: Më
SoLanDiThuyenPLDTrongNgay = 3 -- Giíi h¹n sè lÇn ®i Phong L¨ng §é trong ngµy
ThoiGianBaoDanhPLD = 5
ThoiGianDiThuyenPLD = 15

----------------------------------------------------------------------------------------------------
NPCNhipThiTran = 1 -- 0: §ãng, 1: Më
...
ThoiGianBaoDanhTK = 2 -- Phót
ThoiGianChienDauTK = 40 -- Phót

-- Sè ®iÓm tèi ®a mçi trËn khi ®¸nh ng­êi ch¬i
SoDiemToiDaMoiTran = 200000

-- Chªnh lÖch ng­êi ch¬i mçi bªn
GioiHanChenhLechTK = 8
...
HoatDongPHLT = 1 -- 0: §ãng, 1: Më
SoLanThamGiaPHLTTrongNgay = 3 -- Giíi h¹n sè lÇn ®i Phong Háa Liªn Thµnh trong ngµy

-- B¸o danh giê ch½n
ThoiGianOpenPHLT = {0200, 0400, 0600, 0800, 1000, 1200, 1400, 1600, 1800, 2000, 2200}
ThoiGianBaoDanhPHLT = 2 -- Phót
ThoiGianThuThanhPHLT = 40 -- Phót

----------------------------------------------------------------------------------------------------
-- TriÖu håi Boss Hoµng Kim - Thiªn C¬ L·o Nh©n
...
KinhNghiemNguoiChoiDungXungQuanh = 5000000
TyLeRotDoPho = 0 -- %
TyLeRotTrangBiHoangKim = 30 -- %
