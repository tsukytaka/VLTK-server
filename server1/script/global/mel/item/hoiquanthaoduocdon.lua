...
----------------------------------------------------------------------------------------------------
function main()
	AddSkillState(1301, 1, 1, 7*24*60*60*18,1)
...
function GetDesc(nItemIdx)
    ...
    szDesc = szDesc.."<color=water>Mçi nöa gi©y phôc håi sinh lùc: <color><color=orange>100 ®iÓm<color>\n"
    szDesc = szDesc.."<color=water>Mçi nöa gi©y phôc håi néi lùc: <color><color=orange>100 ®iÓm<color>"
    return szDesc
end