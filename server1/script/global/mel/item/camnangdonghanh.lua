...
function TienIchMenu()
    local tbSay = {"CÈm Nang §ång Hµnh - TiÖn Ùch:"}
...
function add_prop_str()
    AskClientForNumber("enter_str_num", 0, GetProp(), "Xin h·y nhË­ ®iÓm så sõc m¹nh: ")
end

function add_prop_dex()
    AskClientForNumber("enter_dex_num", 0, GetProp(), "Xin h·y nhË­ ®iÓm så th©n ph¸p: ")
end

function add_prop_vit()
    AskClientForNumber("enter_vit_num", 0, GetProp(), "Xin h·y nhË­ ®iÓm så ngo¹i c«ng: ")
end

function add_prop_eng()
    AskClientForNumber("enter_eng_num", 0, GetProp(), "Xin h·y nhË­ ®iÓm så næi c«ng: ")
end
