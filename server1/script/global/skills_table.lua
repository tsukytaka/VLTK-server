...
function add_tw(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄÌìÍõ¼¼ÄÜ
...
function add_sl(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄÉÙÁÖ¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
...
function add_tm(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄÌÆÃÅ¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
...
function add_wu(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄÎå¶¾¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
...
function add_em(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄ¶ëáÒ¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
...
function add_cy(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄ´äÑÌ¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
...
function add_tr(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄÌìÈÌ¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
...
function add_gb(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄØ¤°ï¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
...
function add_wd(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄÎäµ±¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
...
function add_kl(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄÀ¥ÂØ¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
...
function add_hs(lvl)
        if (lvl < 90) and (GetLevel() >= 90) then lvl = 90 end			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄ»ªÉ½¼¼ÄÜ
	if (lvl >= 10) then			-- ÒÑ¾­ÈëÃÅ£¨¼ÓÈëÃÅ¼¼ÄÜ£©
