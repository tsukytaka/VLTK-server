...
if EventThangDangMo(1) == 1 and tonumber(EventThangLuaChon) == 1 then nTime = 0 end
tbConfig = {}
tbConfig[1] = --Tèng Kim 1000 §iÓm
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},10,"[Event_Mõng Sinh NhËt VLTK] [tTongKim1000]"} },
	},
}
tbConfig[2] = --Tèng Kim 3000 §iÓm
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},20,"[Event_Mõng Sinh NhËt VLTK] [tTongKim3000]"} },
	},
}
tbConfig[3] =
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},10,"[Event_Mõng Sinh NhËt VLTK] [tVuotAi17]"} },
	},
}
tbConfig[4] =
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},20,"[Event_Mõng Sinh NhËt VLTK] [tVuotAi28]"} },
	},
}
tbConfig[5] = --Thñy TÆc §Çu LÜnh
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},10,"[Event_Mõng Sinh NhËt VLTK] [tTieuDietThuyTacDauLinh]"} },
	},
}
tbConfig[6] = --Thñy TÆc §¹i §Çu LÜnh
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},20,"[Event_Mõng Sinh NhËt VLTK] [tTieuDietThuyTacDaiDauLinh]"} },
	},
}
tbConfig[7] = --Viªm §Õ
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},25,"[Event_Mõng Sinh NhËt VLTK] [tVuotAiViemDe10]"} },
	},
}
tbConfig[8] = --Tin Su
{
	...
	tbActition = 
	{
		--{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},20,"[Event_Mõng Sinh NhËt VLTK] [tTinSu10]"} },
	},
}
tbConfig[9] = --V­LMC
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},10,"[Event_Mõng Sinh NhËt VLTK] [tVLMC]"} },
	},
}
tbConfig[10] = --Boss ThÕ Giíi
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},50,"[Event_Mõng Sinh NhËt VLTK] [tTieuDietBossTheGioi]"} },
	},
}
tbConfig[11] = --Boss S¸t Thñ
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},5,"[Event_Mõng Sinh NhËt VLTK] [tTieuDietBossS¸tThñ]"} },
	},
}
tbConfig[12] = --?»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"NpcFunLib:DropSingleItem",	{{nExpiredTime=0,tbProp={6,1,1652,1,0,0},},1,"5"} },
		{"NpcFunLib:DropSingleItem",	{{nExpiredTime=0,tbProp={6,1,1657,1,0,0},},1,"5"} },
		{"NpcFunLib:DropSingleItem",	{{nExpiredTime=0,tbProp={6,1,1658,1,0,0},},1,"3"} },
		{"NpcFunLib:DropSingleItem",	{{nExpiredTime=0,tbProp={6,1,1659,1,0,0},},1,"1"} },
	},
}
...
tbConfig[14] = 
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1664,1,0,0},},1,"[Event_Mõng Sinh NhËt VLTK] [B¸nh Kem]"} },
	},
}
tbConfig[15] = 
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1663,1,0,0},},1,"[Event_Mõng Sinh NhËt VLTK] [B¸nh Sinh NhËt]"} },
	},
}
tbConfig[16] = --Sö Dông
{
...
tbConfig[21] = 
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,4938,1,0,0},},1,"[Event_Mõng Sinh NhËt VLTK] [B¸nh Kem]"} },
	},
}
tbConfig[22] = 
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1662,1,0,0},},1,"[Event_Mõng Sinh NhËt VLTK] [B¸nh Sinh NhËt]"} },
	},
}
tbConfig[23] = --Ò»¸öÏ¸½Ú
{
...
tbConfig[24] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1661,1,0,0},},1,"[Event_Mõng Sinh NhËt VLTK] [B¸nh Sinh NhËt]"} },
	},
}
tbConfig[25] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=0,tbProp={6,1,1660,1,0,0},},1,"[Event_Mõng Sinh NhËt VLTK] [B¸nh Sinh NhËt]"} },
	},
}
