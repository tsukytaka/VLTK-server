...
tbMaterial_Medal = {
	[1]={szName="Ph¸o §¹i",tbProp={6,1,1353,1,0,0},nExpiredTime=0,nCount=100,},
	}
tbMaterial_Shijin = {szName="Ng©n L­îng",nJxb=5000,nCount=1,}


tbProduct = {
	[1] = {szName="Phong Ph¸o §¹i §Æc BiÖt",tbProp={6,1,1356,1,0,0},nExpiredTime=0,},
	}
...
function pActivity:InitUpdateCompose()
	...
	for nType=1,getn(%tbMaterial_Medal) do
		...
		tbFormulaList.nRate = %TyLeGhepPhongPhaoDai[nType]
...
function pActivity:toUpdatecompose3(nType)
