...
tbMaterial_Medal = {
	[1]={szName="Ph¸o TiÓu",tbProp={6,1,1351,1,0,0},nExpiredTime=0,nCount=10,},
	}
tbMaterial_Shijin = {szName="Ph¸o Trung",tbProp={6,1,1352,1,0,0},nExpiredTime=0,nCount=2,}
tbMaterial_Money = {szName="Ng©n L­îng",nJxb=1000,nCount=1,}	

tbProduct = {
	[1] = {szName="Phong Ph¸o TiÓu §Æc BiÖt",tbProp={6,1,1354,1,0,0},nExpiredTime=0,},
	}
...
function tbUpdateXunZhang:Compose()
	...
	if bSuccess == 0 then
		...
		tbAwardTemplet:GiveAwardByList({tbProp = {6,1,1357,1,0,0}, nExpiredTime=0,}, "test", 1);
		return 0
	else
